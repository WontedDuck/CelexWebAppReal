...
// Agregar configuraci�n de Key Vault
...
// Configurar la autenticaci�n con Azure AD sin duplicar la configuraci�n de cookies
builder.Services.AddAuthentication(OpenIdConnectDefaults.AuthenticationScheme)
    .AddMicrosoftIdentityWebApp(builder.Configuration.GetSection("AzureAd"))
    .EnableTokenAcquisitionToCallDownstreamApi()
    // Aqu� se configuran los Downstream APIs
...
// Configurar la sesi�n de manera temporal por 30 minutos de inactividad
